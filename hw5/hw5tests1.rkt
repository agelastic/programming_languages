...
(define hw5-tests
  (test-suite
   ...
   (test-case "challenge problem"
              ...
              (check-equal?
               (compute-free-vars (fst (apair f (var "v"))))
               (fst
                (apair
                 (fun-challenge
                  "sum-to"
                  ...
                  (ifgreater
                   (var "x")
                   (int 0)
                   (add (var "x") (call (var "sum-to") (add (var "x") (int -1))))
                   (int 0))
                  (set))
                 (var "v"))) "compute-free-vars, no free vars")
              
              (check-equal?
               (eval-exp-c (call f (int 5)))
               (int 15) "eval-exp-c basic case")
              
              (define p (fun #f
                             "x"
                             (add (add (add (var "x") (var "y")) (var "z")) (var "w"))))
              (check-equal?
               (compute-free-vars p)
               (fun-challenge #f
                              "x"
                              (add (add (add (var "x") (var "y")) (var "z")) (var "w"))
                              (set "w" "y" "z")) "compute-free-vars 2")
              
              (check-equal?
               (compute-free-vars (snd (apair (var "v") p)))
               (snd
                (apair
                 (var "v")
                 (fun-challenge
                  ...
                  "x"
                  (add (add (add (var "x") (var "y")) (var "z")) (var "w"))
                  (set "w" "z" "y")))) "compute-free-vars 3")
              
              (check-equal?
               (eval-exp-c
                (mlet* (list (cons "y" (int 2)) (cons "z" (int 3)) (cons "w" (int 4)))
                       (call p (int 1))))
               (int 10) "eval-exp 2")
              ...
              (check-equal?
               (eval-exp-c
                (mlet "v"
                      (int 20)
                      (mlet* (list (cons "y" (int 2)) (cons "z" (int 3)) (cons "w" (int 4)))
                             (fst (apair (call f (int 5)) (var "v"))))))
               (int 15) "eval-exp-c 3")
              
              (check-equal?
               (eval-exp-c (mlet "v" (int 20) (snd (apair f (var "v")))))
               (int 20) "eval-exp-c with funs 1")
              ...
              (check-equal?
               ...
               (fun-challenge #f
                              "x"
                              (add (var "x") (int 2))
                              (set)) "compute-free-vars 4")
              
              (check-equal?
               (compute-free-vars
                (fun #f
                     "x"
                     (add (var "y") (add (var "x") (int 2)))))
               (fun-challenge #f
                              "x"
                              (add (var "y") (add (var "x") (int 2)))
                              (set "y")) "compute-free-vars 5")
              
              (check-equal?
               (compute-free-vars
                (fun #f
                     "x"
                     (mlet "y" (int 2) (add (var "y") (add (var "x") (int 2))))))
               (fun-challenge #f
                              "x"
                              (mlet "y" (int 2) (add (var "y") (add (var "x") (int 2))))
                              (set)) "compute-free-vars 6"))
